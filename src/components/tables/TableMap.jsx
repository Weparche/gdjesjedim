...
export default function TableMap({
  ...
  return (
    ...
    >
      ...
      {!focusedTable && (
        <div data-map-interactive className="absolute bottom-3 right-3 z-30 flex flex-row items-stretch overflow-hidden rounded-md bg-white/95 shadow-card">
          <button
            type="button"
          ...
          <button
            type="button"
            onClick={fitMap}
            className="flex h-11 min-w-[3rem] items-center justify-center border-x border-cream px-2 font-ui text-[10px] font-semibold tabular-nums text-charcoal transition-colors hover:bg-cream"
